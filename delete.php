...
if (
    ...
    if (
        ...
        if(!$articleC->findArticle($_POST['Tittle']))
        $error = "Tittle doesnt exit!!";
        else
        $articleC->deleteArticle($_POST['Tittle']);
    } else
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post">
              <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Article Tittle</label>
                  <div class="col-sm-10">
