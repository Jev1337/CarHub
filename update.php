...
if (
    ...
    if (
        ...
        if(!$articleC->findArticle($_POST['Title']))
        $error = "Title doesnt exit!";
        else
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="row mb-3">
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">ExpiryDate</label>
                  <div class="col-sm-10">
                    <input class="form-control without_ampm" type="date" name="ExpiryDate">
                </div>
                </div>
                
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Views</label>
                  <div class="col-sm-10">
