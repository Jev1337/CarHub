<?php
    ...
    $userC = new userC;
    if ($userC->ExistsEmail($_POST['email'])){
        if ($userC->CheckResetExistance($userC->getCINfromEMAIL($_POST['email'])))
            $userC->DeleteReset($userC->getCINfromEMAIL($_POST['email']));
            $browser = get_browser(null, true);
            $mail = new PHPMailer(true);
            try {
                $token = $userC->setForgotPasswordAuthCode($userC->getCINfromEMAIL($_POST['email']));
                ...
                //Recipients
                $mail->setFrom('no-reply-carhub@grandelation.com','CarHub - Password Reset');
                $mail->addAddress($_POST['email']);               //Name is optional
            
                //Content
                $mail->isHTML(true);    //Set email format to HTML
                $mail->AddEmbeddedImage('logo.png', 'logo');                              
                $mail->Subject = 'CarHub: Password Forgotten Email';
                                ...
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                      <h1 style="margin: 0; font-size: 24px; line-height: normal; font-weight: bold;"> Reset your <br /> CarHub <br />Password </h1>
                                    </div>
                                  </td>
                                </tr>
                              </tbody></table>
                            ...
                            <div class="mj-column-per-100 mj-outlook-group-fix" style="font-size:0px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                              <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                <tbody><tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                      <p style="margin: 5px 0;">Need to reset your password? No problem. Just click below to get started. </p>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                                      <tbody><tr>
                                        <td align="center" bgcolor="#2e58ff" role="presentation" style="border:none;border-radius:30px;cursor:auto;mso-padding-alt:10px 25px;background:#2e58ff;" valign="middle">
                                          <a href="http://localhost/project2223_2a15-ninjahub/login-register/forgotpassword/forgotpasswordconfirmation.php?token='.$token.'" style="display: inline-block; background: #2e58ff; color: #ffffff; font-family: Helvetica, Arial, sans-serif; font-size: 14px; font-weight: bold; line-height: 30px; margin: 0; text-decoration: none; text-transform: uppercase; padding: 10px 25px; mso-padding-alt: 0px; border-radius: 30px;" target="_blank"> Reset your password </a>
                                        </td>
                                      </tr>
                                    </tbody></table>
                                  </td>
                                ...
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:24px;text-align:left;color:#434245;">
                                      <p style="margin: 5px 0;">If you didn\'t request to change your password, you don\'t have to do anything. </p>
                                      <p style="font-size: 0.875em;">For security, this request was received from a '.$browser['platform'].' device using '.$browser['browser'].'. If you did not request a password reset, please ignore this email or <a href="{{support_url}}">contact support</a> if you have questions.</p>
                                    </div>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                    <div style="font-family:Helvetica, Arial, sans-serif;font-size:18px;font-weight:bold;line-height:24px;text-align:left;color:#434245;">Team CarHub</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
    ...
    header("location: http://localhost/project2223_2a15-ninjahub/uservalidation/success.php?success=9");
?>