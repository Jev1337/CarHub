...
if ($token->is_user_logged_in()) {
  ...
  $nbArticle =$commentsC->allArticle();
  $nbArticleCommented =$commentsC->allArticlesCommented(); 
  $nbArticleNonCommented = $nbArticle - $nbArticleCommented;
  if ($error != null)
...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#service-nav" data-bs-toggle="collapse">
          <i class="bi bi-menu-button-wide"></i><span>Services</span><i class="bi bi-chevron-down ms-auto"></i></i>
        </a>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#article-nav" data-bs-toggle="collapse">
          <i class="bi bi-menu-button-wide"></i><span>Article</span><i class="bi bi-chevron-down ms-auto"></i></i>
        </a>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Statiques</li>
          <li class="breadcrumb-item active">Statique</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">All Statiques</h5>
  ...
  <script>
    var xValues = ["Commented", "None Commented"];
    var yValues = [<?=$nbArticleCommented?>, <?=$nbArticleNonCommented?>];
    var barColors = [
      "#b91d47",
      "#00aba9"
    ];
    ...
    new Chart("myChart", {
      ...
      options: {
        title: {
          display: true,
          text: "How much articles that have comments"
        }
      }
    });
  </script>
