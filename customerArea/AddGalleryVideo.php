...
$Gallery = null;
    ...
    if (
        ...
        if (
            ...
            $galleryC->gallerryvideo($Gallery);
        }
    }
...
<ul class="sidebar-nav" id="sidebar-nav">
            ...
            <div class="card-body">
              ...
              <form method="POST">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="URLVideo" name="URLVideo" onchange="checkurl(event)"  required minlength="3"  class="form-control">
                    </div>
                    </div>
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="duree" name="duree" required minlength="3" maxlength="20" class="form-control">
                  </div>
                </div>
        ...
        <div class="col-lg-4">
          <div class="card">
            <div class="card-body">
              ...
              <iframe width="560" height="315" src="https://www.youtube.com/embed/y881t8ilMyc" id='displayOfVideo' frameborder="0" allowfullscreen></iframe>
            </div>
          </div>
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script>
    ...
    function checkurl(event){
      ...
      if(isValidUrl(url)){
        document.getElementById("displayOfVideo").src=url;
      }
      else
