        ...
        if(preg_match($pattern, $_POST["CarPlate"])){
           if($CarC->findCar($_POST["CarPlate"])){
            ...
            $car = new Car( 
              ...
              $_POST["opt3"], 
              $_POST["opt4"]);
            $CarC->UpdateCar($car,$_POST["CarPlate"]);
           } 
           else 
           $error = "Car plate doesnt exist!";
...
if($_GET["CarPlate"])
{
    $oldcar = $CarC->findCar($_GET["CarPlate"]);
}
            ...
            <div class="card-body">
              ...
              <form method="post">
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="CarPlate" value="<?php if (
                      $oldcar
                    ) {
                      echo $oldcar["CarPlate"];
                    } ?>" >
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Address" placeholder="Avenue,Ville,Pays" value="<?php if (
                      $oldcar
                    ) {
                      echo $oldcar["Address"];
                    } ?>">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input class="form-control" type="number" name="PriceCar"  value="<?php if (
                      $oldcar
                    ) {
                      echo $oldcar["Price"];
                    } ?>" >
