...
$adherentC=new galleryimageC();
if (isset($_GET["search"]) && isset($_GET["page"])) {
    $list = $adherentC->allImagesPages(
      $_GET["page"] * 5,
      ($_GET["page"] + 1) * 5,
      $_GET["search"]
    );
    $max_page = sizeof($adherentC->allImages($_GET["search"]));
  } elseif (isset($_GET["search"])) {
    $list = $adherentC->allImagesPages(0, 5, $_GET["search"]);
    $max_page = sizeof($adherentC->allImages($_GET["search"]));
    ...
    $max_page = sizeof($adherentC->afficherimage());
  } else {
    $list = $adherentC->allImagesPages(0, 5, "");
    $max_page = sizeof($adherentC->afficherimage());
  }
?>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <button><a href="AfficherGallery.php" id="search_url" style="color:black">Search</a></button>
                            <script>
                 ...
                 ?>
                                    <tr>
                                        ...
                                        <td><?= $galleryimage["URLImage"]?></td>
                                        <td><?= $galleryimage["dimension"]?></td>
                                        <td><?= $galleryimage["ModelID"]?></td>
                                        <td><a href="ModifierImage.php?GalleryID=<?= $galleryimage["GalleryID"]?>">✏️</a></td>
                                    </tr>
                                    <?php
                  }
                 ?>
