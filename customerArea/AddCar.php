...
if (
    ...
    isset($_POST["Address"]) &&
    isset($_POST["PriceCar"]) &&
    isset($_POST["isNew"]) &&
    isset($_POST["SaleorRent"]) &&
    isset($_POST["opt1"]) &&
    isset($_POST["opt2"]) &&
    isset($_POST["opt3"]) &&
    isset($_POST["opt4"])
    ...
    if (
      ...
      !empty($_POST["opt4"])
        ...
        if(preg_match($pattern, $_POST["CarPlate"])){
          $ModelChosen=$ModelC->getModelFromModelName($_POST["ModelName"]);
          $car = new Car( 
            $_POST["CarPlate"],
            $_SESSION['user_id'], 
            $_POST["ModelName"], 
...
<a class="nav-link nav-icon" href="./cart.php" data-bs-toggle="dropdown">
  ...
  <span class="badge bg-success badge-number"><?php if (!$cartC->checkCartExistPerUser($_SESSION['user_id'])) echo('0'); else echo $cartC->listcart($cartC->seekCartID($_SESSION['user_id']))->rowCount(); ?></span>
</a><!-- End Messages Icon -->

<ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
  <li class="dropdown-header">
    You have <?php if (!$cartC->checkCartExistPerUser($_SESSION['user_id'])) echo('0'); else echo $cartC->listcart($cartC->seekCartID($_SESSION['user_id']))->rowCount(); ?> cart items
    <a href="./cart.php"><span class="badge rounded-pill bg-primary p-2 ms-2">View all</span></a>
  </li>
  <li>
    <hr class="dropdown-divider">
  </li>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form method="post">
                ...
                <div class="row mb-3">
                  <label for="inputEmail" class="col-sm-2 col-form-label">Model Name</label>
                  <div class="col-sm-10">
                    <select name="ModelName" id="cars" class="form-control">
                      <?php
                        foreach ($models as $model) {
                          echo '<option value="'.$model['Manufacturer'].'">'.$model['Manufacturer'].'</option>';
                        }
                      ?>
                    </select>
                  </div>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="Address" placeholder="Avenue,Ville,Pays">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">Price</label>
                  <div class="col-sm-10">
                    <input class="form-control" type="number" name="PriceCar" step="10">
                  </div>
                </div>
                ...
                <fieldset class="row mb-3">
                  <legend class="col-form-label col-sm-2 pt-0">Car</legend>
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="isNew" id="gridRadios1" value="1" checked>
                      <label class="form-check-label" for="gridRadios1">
                        New car
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="isNew" id="gridRadios2" value="0">
                ...
                <fieldset class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="SaleorRent" id="gridRadios1" value="1" checked>
                      <label class="form-check-label" for="gridRadios1">
                        For Sale
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input" type="radio" name="SaleorRent" id="gridRadios2" value="0">
                      <label class="form-check-label" for="gridRadios2">
                        For Rent
                      </label>
                    </div>
