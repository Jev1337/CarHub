...
if ($token->is_user_logged_in()){
    ...
    if($transactionC->checkCartExistPerUser($_SESSION['user_id']))
      if($transactionC->TransactionExist($transactionC->seekCartID($_SESSION['user_id']))){
        header('Location: http://localhost/project2223_2a15-ninjahub/customerArea/confirmtransaction.php');
    }
  }
}else
...
$cartC = new cartC();
$cartServices = $cartC->seekALLCartID($_SESSION['user_id']);
    ...
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="col-lg-8">
              ...
              $res = $cartC->listcart($cartC->seekCartID($_SESSION['user_id']));
              echo("<table class='table table-hover'><th></th><th></th><th></th><th>Fee of Service</th>");
              $s = 0.0;
              while($row = $res->fetch()){
                echo "<tr><td><a HREF='http://localhost/project2223_2a15-ninjahub/core/View/removecart.php?rem=".$row['IDServ']."'>Remove</a></td><td>".$row['DescServ']."</td><td>".$row['DurationServ']."</td><td>".$row['PriceServ']." TND</td></tr>";
                $s += $row['PriceServ'];
              }
              
              echo "<tr><td></td><td></td><td></td><td><b>TOTAL : ".$s." TND</b></td></tr>";
              echo("</table>");
            }
              ?>
      ...
      ?>
            ...
            <form method="POST" action="../core/View/transactioncreation.php">
                    ...
                    <div class="row">
                        ...
                        <div class="card" >
                            <div class="card-body">
                                ...
                                <fieldset class="row mb-3">
                                    <div class="col-sm-10">
                                        <div class="form-check">
                                            <input
                                                onclick="document.getElementById('inop').style.display='inline'; document.getElementById('checkoutMain').style.display='none';"
                                        ...
                                        <div class="form-check">
                                            <input
                                                onclick="document.getElementById('inop').style.display='none'; document.getElementById('checkoutMain').style.display='inline';"
                                ...
                                <button style="display:none" id="checkoutMain" type="submit"
