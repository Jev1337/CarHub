...
header('Location: http://localhost/project2223_2a15-ninjahub/login-register');
        ...
        if (
            ...
            !empty($_POST["ModelID"])
                ...
                $galleryC->modifierimage($Gallery);
            }else
            $error = "Missing info";
        }
        ...
        $oldGallery = $galleryC->afficherimagebyid($_GET["GalleryID"]);   
        ...
        <section class="section">
            <div class="row">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="GalleryID" name="GalleryID" required minlength="3" maxlength="20" class="form-control" <?php
                    if($oldGallery){
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="descG" <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["description"];
                    }
                    ?>  name="descG" required minlength="3" maxlength="20" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputtext" class="col-sm-2 col-form-label">URLImage</label>
                  <div class="col-sm-10">
                    <input type="text" id="URLImage"  <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["URLImage"];
                    }
                    ?>  name="URLImage"  required class="form-control">
                    </div>
                    <div class="row mb-3">
                  <label for="inputtext" class="col-sm-2 col-form-label">dimension</label>
                  <div class="col-sm-10">
                    <input type="text" id="dimension" <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["dimension"];
                    }
                    ?>  name="dimension" required minlength="3" maxlength="20" class="form-control">
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    ...
                    ?>  id="ModelID" name="ModelID" required minlength="3" maxlength="20" class="form-control" >
                  </div>
                </div>
                <input onclick=FormCOntrol() type="submit" value="Update" name="submit" class="btn btn-primary">
