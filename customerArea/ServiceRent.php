...
$listPlate = $serviceC->allPlateForRent();
$cart = null;
...
if (
    isset($_POST["CarPlate"])
        ...
        if(!$carC->findCar($_POST['CarPlate']))
         header('Location: http://localhost/project2223_2a15-ninjahub/uservalidation/unsuccess.php?unsuccess=2');
        else
        {
            $car = $carC->findCar($_POST["CarPlate"]);
            
            $carRes = new car($car["CarPlate"],$car["CIN"],$car["ModelName"],$car["ModelID"],$car["Address"],$car["Price"],$car["isNew"],-1,$car["opt1"],$car["opt2"],$car["opt3"],$car["opt4"]);
            $carC->UpdateCar($carRes,$_POST["CarPlate"]);
            header('Location: http://localhost/project2223_2a15-ninjahub/uservalidation/success.php?success=2');
        }
    }
...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link" data-bs-target="#charts-nav" data-bs-toggle="collapse">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
                <a href="ServiceRent.php" class="active">
    ...
    <main id="main" class="main">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="post">
                                <div class="row mb-3">
                                    <label for="inputEmail" class="col-sm-2 col-form-label">Car Plate for rent</label>
                                    <div class="col-sm-10">
                                        <select class="form-select" name="CarPlate" aria-label="Default select example" onchange="carPlateChosen(event)">
                                            <option selected value="">Choose Car Plate</option>
                                            <?php
                      while($row = $listPlate->fetch()) {
                      ?>
                                            <option value=<?= $row['carplate']; ?>><?= $row['carplate']; ?></option>
                                            <?php
                        }
                      ?>
                                        </select>
                ...
                <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Display car</h5>

                            <div class="portfolio-image">
								<a href="#" >
									<img class="imageShow" src="https://www.salonlfc.com/wp-content/uploads/2018/01/image-not-found-scaled.png" alt="Open Imagination">
									
									<div class="filter-p-pricing">
										<span class="p-price fw-bold ls1" id="CarDisplayName">No car plate was chosen</span>
                                        <br>
									</div>
								</a>
							</div>
    ...
    function carPlateChosen(event) {
        document.getElementById("CarDisplayName").innerHTML = event.target.value
