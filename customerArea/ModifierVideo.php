...
header('Location: http://localhost/project2223_2a15-ninjahub/login-register');
        ...
        $galleryC = new galleryvideoC();
        if (
            isset($_POST["GalleryID"]) &&
            isset($_POST["Nom"]) &&
            isset($_POST["descG"]) &&
            ...
            !empty($_POST["ModelID"])
                ...
                $galleryC->modifiervideo($Gallery);
            }
            else
...
$oldGallery = $galleryC->affichervideobyid($_GET["GalleryID"]);   
        ...
        <section class="section">
            <div class="row">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="GalleryID" name="GalleryID" required minlength="3" <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["GalleryID"];
                    }
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="Nom" name="Nom" required minlength="3" <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["nom"];
                    }
                    ?>  maxlength="20" class="form-control">
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="descG" name="descG" required minlength="3" <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["description"];
                    }
                    ?>  maxlength="20" class="form-control">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputtext" class="col-sm-2 col-form-label">URLVideo</label>
                  <div class="col-sm-10">
                    <input type="text" id="URLVideo" name="URLVideo"  <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["URLVideo"];
                    }
                    ?>    required minlength="3" maxlength="20" class="form-control">
                    </div>
                    <div class="row mb-3">
                  <label for="inputtext" class="col-sm-2 col-form-label">duree</label>
                  <div class="col-sm-10">
                    <input type="text" id="duree" name="duree"  <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["duree"];
                    }
                    ?>   required minlength="3" maxlength="20" class="form-control">
                  </div>
                  <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" id="ModelID" name="ModelID" required minlength="3" maxlength="20"  <?php
                    if($oldGallery){
                        echo 'value='.$oldGallery["ModelID"];
                        echo ' ';
                        echo 'disabled';
                    }
                    ?>   class="form-control">
                ...
                <input onclick=FormCOntrol2() type="submit" value="Submit" namee="Submit" class="btn btn-primary">
