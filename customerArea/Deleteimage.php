...
if (
  ...
  if (
    ...
    $galleryC->deleteimage($_POST["GalleryID"]);
  }
  else
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="Service.php">
                    <i class="bi bi-journal-text"></i><span>Our Services</span></i>
                </a>
            </li><!-- End Forms Nav -->
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" data-bs-target="#gallery-nav" data-bs-toggle="collapse">
                    <i class="bi bi-menu-button-wide"></i><span>Gallery</span><i
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" id="GalleryID" name="GalleryID" required minlength="3"
                                            maxlength="20" class="form-control">
                                    </div>
                                </div>
                                <input onclick=FormCOntrol() type="submit" value="Submit" namee="Submit"
