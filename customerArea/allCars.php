        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                 ...
                 ?>
                                    <tr>
                                        <th scope="row"><?= $car["CarPlate"]?></th>
                                        <td><?= $car["ModelName"]?></td>
                                        <td><?= $car["Address"]?></td>
                                        <td><?= $car["Price"]?></td>
                                        <td><?= $car["isNew"]?></td>
                                        <td><?= $car["SaleorRent"]?></td>
                                        <td><?= $car["opt1"]?> | <?= $car["opt2"]?> | <?= $car["opt3"]?> | <?= $car["opt4"]?>  </td>
                                        <?php
                                            if($car["CIN"] ==$_SESSION['user_id'])
                                            echo '<td><a href="ModifyCar.php?CarPlate='.$car["CarPlate"].'">✏️</a></td>';
                                            else
                                            echo "<td></td>"
                                        ?>
