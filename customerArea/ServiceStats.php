...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
                <a href="ServiceStats.php" class="active">
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">State Service</h5>
                            <canvas id="soldState" style="width:100%;max-width:700px"></canvas>
                            <script>
                                var xValues = [];
                                <?php
                            ...
                            ?>
                                ...
                                ?>
                                yValues.push('<?php 
                                   echo $cartC->countServ($service['IDServ']);
                                ?>')
                            ...
                            ?>
                                ...
                                options: {
                                    ...
                                    title: {
                                    display: true,
                                    text: "Most Sold services"
                                    }
                                }
                                });
                            </script>
                            <br><br><br>
                            <canvas id="hoursState" style="width:100%;max-width:700px"></canvas>
                            <script>
                                var xValues = [];
                                <?php
                                    foreach ($list as $service) {
                            ...
                            ?>
                                ...
                                <?php
                                    foreach ($list as $service) {
                                       $time = explode(':',$service['DurationServ']);
                                       
                                ?>
                                yValues.push('<?= (int)$time[0] . '.' . $time[1];?>')
