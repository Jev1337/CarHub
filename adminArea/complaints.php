                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-borderless datatable">
                                ...
                                <tbody>
                                    <?php
                                    if($complaintC->ExistAllUser()){
                                $res = $complaintC->listAllUserComplaints();
                 while($row = $res->fetch()){
                   
                   echo ("<tr><th scope='row'><a href='#'>".$row['ID']."</a></th><td>".$row['CIN']."</td><td>".$row['Title']."</td><td><a href='#' class='text-primary'>".$row['Description']."</a></td>");
                   if($row['IsPending'] && !$row['IsRejected']){
                        echo("<td><span class='badge bg-warning'>Pending Review</span></td>");
                        echo("<td><button onclick='location.href=\"http://localhost/project2223_2a15-ninjahub/core/View/acceptComplaint.php?complaintID=".$row['ID']."\"' type='button' class='btn btn-success'><i class='bi bi-check-circle'></i></button> <button onclick='location.href=\"http://localhost/project2223_2a15-ninjahub/core/View/declineComplaint.php?complaintID=".$row['ID']."\"' type='button' class='btn btn-danger'><i class='bi bi-exclamation-octagon'></i></button></td></tr>");
                    }
                   else if (!$row['IsRejected']){
                        echo("<td><span class='badge bg-success'>Solved</span></td>");
                        echo("<td><button onclick='location.href=\"http://localhost/project2223_2a15-ninjahub/core/View/pendComplaint.php?complaintID=".$row['ID']."\"' type='button' class='btn btn-warning'><i class='bi bi-exclamation-triangle'></i></button>");
                    }
                    else{
