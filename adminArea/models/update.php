  ...
  if (
    ...
    if (
      ...
      if (is_numeric($_POST["Manufacturer"])) {
        ...
        if ($ModelC->findModel($_POST["ModelID"])) {
          $model = new Model(
            $_POST["ModelID"],
            $_POST["Manufacturer"],
            $_POST["HP"],
          ...
          $ModelC->UpdateModel($model);
        } else {
          $error = "Model doesnt exit!";
        }
      }
    } else {
...
if ($_GET["ModelID"]) {
  $oldModel = $ModelC->getModel($_GET["ModelID"]);
}
      ...
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              ...
              <form method="post">
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Model ID</label>
                  <div class="col-sm-10">
                    <input type="text" id="ModelID" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["ModelID"];
                    } ?>" 
                      class="form-control" name="ModelID">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Manufacturer</label>
                  <div class="col-sm-10">
                    <input type="text" id="Manufacturer" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["Manufacturer"];
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" id="HP" value="<?php if ($oldModel) {
                      echo $oldModel["HP"];
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" id="kW" value="<?php if ($oldModel) {
                      echo $oldModel["kW"];
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="number" id="Acceleration" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["Acceleration"];
                    } ?>"  class="form-control" name="Acceleration" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                  <label for="inputNumber" class="col-sm-2 col-form-label">MaxSpeed</label>
                  <div class="col-sm-10">
                    <input class="form-control" id="MaxSpeed" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["MaxSpeed"];
                    } ?>"  type="number" name="MaxSpeed">
                  </div>
                </div>
                ...
                <label class="col-sm-2 col-form-label">InGearAccel</label>
                  <div class="col-sm-10">
                    <input type="number" id="InGearAccel" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["InGearAccel"];
                    } ?>"  class="form-control" name="InGearAccel">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Flex5Gear</label>
                  <div class="col-sm-10">
                    <input type="number" id="Flex5Gear" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["Flex5Gear"];
                    } ?>"  class="form-control" name="Flex5Gear">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">EngineLayout</label>
                  <div class="col-sm-10">
                    <input type="text" id="EngineLayout" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["EngineLayout"];
                    } ?>"  class="form-control" name="EngineLayout">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">NumberOfCyl</label>
                  <div class="col-sm-10">
                    <input type="number" id="NumberOfCyl" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["NumberOfCyl"];
                    } ?>"  class="form-control" name="NumberOfCyl" step="1">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Displacement</label>
                  <div class="col-sm-10">
                    <input type="number" id="Displacement" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["Displacement"];
                    } ?>"  class="form-control" name="Displacement" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">FuelConsumptUrb</label>
                  <div class="col-sm-10">
                    <input type="number" id="FuelConsumptUrb" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["FuelConsumptUrb"];
                    } ?>"  class="form-control" name="FuelConsumptUrb" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">FuelConsumptNonUrb</label>
                  <div class="col-sm-10">
                    <input type="number" id="FuelConsumptNonUrb" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["FuelConsumptNonUrb"];
                    } ?>"  class="form-control" name="FuelConsumptNonUrb" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">FuelConsumptComb</label>
                  <div class="col-sm-10">
                    <input type="number" id="FuelConsumptComb" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["FuelConsumptComb"];
                    } ?>"  class="form-control" name="FuelConsumptComb" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">CO2Emissions</label>
                  <div class="col-sm-10">
                    <input type="number" id="CO2Emissions" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["CO2Emissions"];
                    } ?>"  class="form-control" name="CO2Emissions" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">BodyLength</label>
                  <div class="col-sm-10">
                    <input type="number" id="BodyLength" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["BodyLength"];
                    } ?>"  class="form-control" name="BodyLength" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">BodyWidth</label>
                  <div class="col-sm-10">
                    <input type="number" id="BodyWidth" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["BodyWidth"];
                    } ?>"  class="form-control" name="BodyWidth" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">BodyHeight</label>
                  <div class="col-sm-10">
                    <input type="number" id="BodyHeight" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["BodyHeight"];
                    } ?>"  class="form-control" name="BodyHeight" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">UnladenWeightDin</label>
                  <div class="col-sm-10">
                    <input type="number" id="UnladenWeightDin" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["UnladenWeightDin"];
                    } ?>"  class="form-control" name="UnladenWeightDin" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">UnladenWeightEU</label>
                  <div class="col-sm-10">
                    <input type="number" id="UnladenWeightEU" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["UnladenWeightEU"];
                    } ?>"  class="form-control" name="UnladenWeightEU" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">DragCoefficientCd</label>
                  <div class="col-sm-10">
                    <input type="number" id="DragCoefficientCd" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["DragCoefficientCd"];
                    } ?>"  class="form-control" name="DragCoefficientCd" step="0.5">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Overview</label>
                  <div class="col-sm-10">
                    <input type="text" id="Overview" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["Overview"];
                    } ?>"  class="form-control" name="Overview">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">TechSpecs</label>
                  <div class="col-sm-10">
                    <input type="text" id="TechSpecs" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["TechSpecs"];
                    } ?>"  class="form-control" name="TechSpecs">
                  </div>
                </div>
                <div class="row mb-3">
                <label class="col-sm-2 col-form-label">TypeCar</label>
                  <div class="col-sm-10">
                    <input type="text" id="TypeCar" value="<?php if (
                      $oldModel
                    ) {
                      echo $oldModel["TypeCar"];
                    } ?>"  class="form-control" name="TypeCar">
                  </div>
                </div>
