...
<ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
        ...
        <ul id="model-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
            ...
            <li>
                <a href="allModels.php" class ="active">
              ...
              <table class="table">
                ...
                <?php foreach ($list as $Model) { ?>
                  <tr>
                    ...
                    <td><?= $Model["Manufacturer"] ?> DT</td>
                    <td>
                      HP: <?= $Model["HP"] ?>|
                      KW: <?= $Model["kW"] ?>|
                      Acceleration: <?= $Model["Acceleration"] ?> |
                      MaxSpeed: <?= $Model["MaxSpeed"] ?>|
                      InGearAccel: <?= $Model["InGearAccel"] ?>|
                      Flex5Gear: <?= $Model["Flex5Gear"] ?>|
                      NumberOfCyl: <?= $Model["NumberOfCyl"] ?></td>
                    <td><?= $Model["Overview"] ?></td>
                    <td><?= $Model["TechSpecs"] ?></td>
                    <td><?= $Model["TypeCar"] ?></td>
                    <td><a href='update.php?ModelID=<?= $Model[
                      "ModelID"
                    ] ?>'>✏️</a></td>
                  </tr>
