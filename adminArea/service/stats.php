      ...
      <div class="row">
        ...
        <div class="card">
                        <div class="card-body">
                            ...
                            <canvas id="states" style="width:100%;max-width:700px"></canvas>
                            <script>
                                var xValues = [];
                                ...
                                <?php foreach ($list as $service) {
                                  ...
                                  if ($cartC->countServ($service["IDServ"])) {
                                    $priceMade =
                                      $service["PriceServ"] *
                                      $cartC->countServ($service["IDServ"]);
                                  } else {
                                    $priceMade = 0;
                                  }
                                  $TotalMoneyMade += $priceMade;
                                  ?>
                                  yValues.push('<?= $priceMade ?>')
                                <?php
                                } ?>
                                var barColors = [];
                        ...
                        Total Monay earned:  <span class="badge bg-success"> <?= $TotalMoneyMade ?> DT</span>
                              </h5>
                        </div>
                    </div>
          </div>
